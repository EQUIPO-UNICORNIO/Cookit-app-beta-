...
const SUGGESTED_MEALS = [
  { name: 'Pollo al horno con verduras', recipe: 'Pollo al horno', ingredients: ['Pollo', 'Patatas', 'Zanahoria', 'Aceite de oliva', 'Sal', 'Pimienta', 'Ajo'], instructions: '1. Precalienta el horno a 200°C.\n2. Sazona el pollo con sal, pimienta y ajo.\n3. Corta patatas y zanahorias.\n4. Coloca todo en bandeja con aceite.\n5. Hornea 45-50 min.' },
  { name: 'Ensalada César', recipe: 'Ensalada César', ingredients: ['Lechuga', 'Pollo', 'Pan', 'Queso parmesano', 'Aceite de oliva', 'Limón', 'Ajo', 'Mostaza'], instructions: '1. Cocina el pollo a la plancha.\n2. Corta el pan en cubos y tuéstalos.\n3. Mezcla lechuga con pollo.\n4. Añade aliño y queso.' },
  { name: 'Tacos de pescado', recipe: 'Tacos', ingredients: ['Pescado blanco', 'Tortillas de maíz', 'Col', 'Crema agria', 'Limón', 'Aguacate', 'Cebolla', 'Cilantro'], instructions: '1. Cocina el pescado.\n2. Calienta tortillas.\n3. Monta con col y crema.\n4. Exprime limón.' },
  { name: 'Smoothie verde', recipe: 'Smoothie', ingredients: ['Espinacas', 'Plátano', 'Manzana', 'Jengibre', 'Agua', 'Miel'], instructions: '1. Lava todo.\n2. Corta en trozos.\n3. Licúa con agua.\n4. Sirve frío con miel.' },
  { name: 'Omelette de espinacas', recipe: 'Omelette', ingredients: ['Huevos', 'Espinacas', 'Tomate', 'Queso', 'Aceite de oliva', 'Sal'], instructions: '1. Bate los huevos.\n2. Saltea espinacas y tomate.\n3. Vierte huevos en sartén.\n4. Añade queso y dobla.' },
  { name: 'Pasta primavera', recipe: 'Pasta', ingredients: ['Pasta', 'Calabacín', 'Berenjena', 'Tomate', 'Ajo', 'Aceite de oliva', 'Albahaca', 'Sal'], instructions: '1. Cocina la pasta.\n2. Saltea las verduras.\n3. Mezcla todo.\n4. Sirve con albahaca.' },
  { name: 'Arroz con pollo', recipe: 'Arroz con pollo', ingredients: ['Arroz', 'Pollo', 'Cebolla', 'Ajo', 'Pimiento', 'Caldo de pollo', 'Aceite de oliva', 'Sal'], instructions: '1. Dora el pollo.\n2. Agrega cebolla y ajo.\n3. Añade arroz y caldo.\n4. Cocina 20 min.' },
  { name: 'Hamburguesa casera', recipe: 'Hamburguesa', ingredients: ['Carne picada', 'Pan de hamburguesa', 'Lechuga', 'Tomate', 'Queso cheddar', 'Cebolla', 'Mostaza', 'Ketchup'], instructions: '1. Forma hamburguesas.\n2. Cocina a la plancha.\n3. Tuesta el pan.\n4. Monta con toppings.' },
  { name: 'Tortilla de patatas', recipe: 'Tortilla', ingredients: ['Patatas', 'Huevos', 'Cebolla', 'Aceite de oliva', 'Sal'], instructions: '1. Corta patatas en rodajas.\n2. Fríe con cebolla.\n3. Bate huevos.\n4. Mezcla y cuaja por ambos lados.' },
  { name: 'Gazpacho andaluz', recipe: 'Gazpacho', ingredients: ['Tomate', 'Pimiento', 'Pepino', 'Ajo', 'Pan', 'Aceite de oliva', 'Vinagre', 'Sal', 'Agua'], instructions: '1. Lava y trocea verduras.\n2. Remoja pan.\n3. Tritura todo.\n4. Refrigera 2 horas.' },
  { name: 'Macarrones con tomate', recipe: 'Macarrones', ingredients: ['Macarrones', 'Tomate triturado', 'Cebolla', 'Ajo', 'Aceite de oliva', 'Queso rallado', 'Sal', 'Orégano'], instructions: '1. Cocina macarrones.\n2. Sofríe cebolla y ajo.\n3. Añade tomate.\n4. Mezcla con pasta y queso.' },
  { name: 'Ensalada mixta', recipe: 'Ensalada', ingredients: ['Lechuga', 'Tomate', 'Cebolla', 'Atún en lata', 'Aceite de oliva', 'Vinagre', 'Sal'], instructions: '1. Lava y corta lechuga.\n2. Corta tomate y cebolla.\n3. Escurre atún.\n4. Mezcla y aliña.' },
  { name: 'Pollo a la plancha', recipe: 'Pollo plancha', ingredients: ['Pollo', 'Aceite de oliva', 'Sal', 'Pimienta', 'Limón'], instructions: '1. Sazona el pollo.\n2. Calienta aceite.\n3. Cocina 5 min por lado.\n4. Añade limón.' },
  { name: 'Crema de calabaza', recipe: 'Crema', ingredients: ['Calabaza', 'Cebolla', 'Ajo', 'Caldo de verduras', 'Nata', 'Aceite de oliva', 'Sal'], instructions: '1. Pela y corta calabaza.\n2. Sofríe cebolla y ajo.\n3. Añade caldo.\n4. Cocina y tritura.' },
  { name: 'Wrap de atún', recipe: 'Wrap', ingredients: ['Tortillas de trigo', 'Atún en lata', 'Lechuga', 'Tomate', 'Mayonesa', 'Maíz dulce', 'Sal'], instructions: '1. Mezcla atún con mayonesa.\n2. Coloca lechuga en tortilla.\n3. Añade atún y tomate.\n4. Enrolla.' },
  { name: 'Yogur con granola', recipe: 'Yogur', ingredients: ['Yogur natural', 'Granola', 'Miel', 'Plátano', 'Fresas', 'Frutos secos'], instructions: '1. Coloca yogur en bol.\n2. Corta frutas.\n3. Añade granola.\n4. Rocía con miel.' },
  { name: 'Salmón al horno', recipe: 'Salmón', ingredients: ['Salmón', 'Limón', 'Eneldo', 'Aceite de oliva', 'Sal', 'Pimienta', 'Patatas'], instructions: '1. Precalienta horno 180°C.\n2. Coloca salmón en bandeja.\n3. Sazona con limón.\n4. Hornea 20 min.' },
  { name: 'Revuelto de champiñones', recipe: 'Revuelto', ingredients: ['Huevos', 'Champiñones', 'Ajo', 'Perejil', 'Aceite de oliva', 'Sal', 'Pimienta'], instructions: '1. Lamina champiñones.\n2. Saltea con ajo.\n3. Bate huevos.\n4. Añade y remueve.' },
  { name: 'Lentejas estofadas', recipe: 'Lentejas', ingredients: ['Lentejas', 'Zanahoria', 'Patata', 'Cebolla', 'Ajo', 'Tomate', 'Pimentón', 'Aceite de oliva', 'Sal'], instructions: '1. Sofríe cebolla y ajo.\n2. Añade tomate.\n3. Incorpora lentejas y patata.\n4. Cocina 40 min.' },
  { name: 'Fajitas de pollo', recipe: 'Fajitas', ingredients: ['Pollo', 'Tortillas de trigo', 'Pimiento', 'Cebolla', 'Comino', 'Pimentón', 'Limón', 'Aguacate'], instructions: '1. Corta pollo en tiras.\n2. Marina con especias.\n3. Saltea con verduras.\n4. Sirve en tortillas.' },
];
